...
conn = pymysql.connect(host='192.168.159.23', user='root',password='123456',database='test',charset='utf8')
cursor = conn.cursor()
...
def make_sql(q, result):
    ...
    s12= result[9]
    s13= 'c'
    sql1 = "insert into  set_basestation_3   values('{}', '{}', '{}', '{}', NULL, NULL, NULL, NULL, '{}', NULL, NULL, '{}',".format(s0,s1,s2,s3,s4,s5)
    str  =  'NULL,'
