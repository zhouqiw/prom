...
class linatong:
    ...
    def next_make(self,l):
        print(l)
        sql = "SELECT Alternate5,Alternate6 from set_basestation where Site_ID='{}'".format(l[6])
        try:
        ...
        try:
            if len(results)!= 0:
                sql_update = "update set_basestation_1 set Alternate5='{}',Alternate6='{}' where Site_ID ={}".format(results[0][0],results[0][1],l[5])
                self.cursor.execute(sql)
